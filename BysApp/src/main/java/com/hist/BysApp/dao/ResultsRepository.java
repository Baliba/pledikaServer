...
//	
	 ...
	 @Query("SELECT new com.hist.BysApp.model.MoyDto(SUM(r.coef*r.note),SUM(r.coef*r.note_total),r.parcours_frag.parcours.user.lastName,r.parcours_frag.parcours.user.firstName,r.code_student,r.parcours_frag.parcours.id_student,r.parcours_frag.parcours.actived) FROM Results r where  r.parcours_frag.parcours.actived=true AND r.parcours_frag.promofrag.actived=true AND r.parcours_frag.promofrag.base=true AND r.parcours_frag.parcours.promotion.id=:id  GROUP BY r.parcours_frag.parcours.user.lastName,r.parcours_frag.parcours.user.firstName, r.code_student,r.parcours_frag.parcours.id_student,r.parcours_frag.parcours.actived  ")
	 ...
	 @Query("SELECT new com.hist.BysApp.model.MoyDto(SUM(r.coef*r.note),SUM(r.coef*r.note_total),r.parcours_frag.parcours.user.lastName,r.parcours_frag.parcours.user.firstName,r.code_student,r.parcours_frag.parcours.id_student,r.parcours_frag.parcours.actived,r.parcours_frag.parcours.id, r.parcours_frag.parcours.promotion.moy_total, r.parcours_frag.parcours.promotion.moy_accept,r.parcours_frag.parcours.user.lover) FROM Results r where  r.parcours_frag.promofrag.actived=true AND r.parcours_frag.promofrag.base=true AND r.parcours_frag.parcours.promotion.code_niveau=:code  AND r.parcours_frag.parcours.promotion.promo_af.id=:id  GROUP BY r.parcours_frag.parcours.id, r.parcours_frag.parcours.user.lover, r.parcours_frag.parcours.promotion.moy_total, r.parcours_frag.parcours.promotion.moy_accept, r.parcours_frag.parcours.user.lastName,r.parcours_frag.parcours.user.firstName, r.code_student,r.parcours_frag.parcours.id_student,r.parcours_frag.parcours.actived  ")
	 List<MoyDto> getEtudiantsToOver(@Param("id") Long id , @Param("code") String code); 
	 
	 @Query("SELECT new com.hist.BysApp.model.MoyDto(SUM(r.coef*r.note),SUM(r.coef*r.note_total),r.parcours_frag.parcours.user.lastName,r.parcours_frag.parcours.user.firstName,r.code_student,r.parcours_frag.parcours.id_student,r.parcours_frag.parcours.actived,r.parcours_frag.parcours.id, r.parcours_frag.parcours.promotion.moy_total, r.parcours_frag.parcours.promotion.moy_accept,r.parcours_frag.parcours.user.lover,r.parcours_frag.parcours.promotion.moy_reprise) FROM Results r WHERE  r.parcours_frag.promofrag.reprise=false AND  r.parcours_frag.parcours.actived=true AND r.parcours_frag.promofrag.actived=true AND r.parcours_frag.promofrag.base=true AND r.parcours_frag.parcours.promotion.id=:id   GROUP BY r.parcours_frag.parcours.promotion.moy_reprise, r.parcours_frag.parcours.id, r.parcours_frag.parcours.user.lover, r.parcours_frag.parcours.promotion.moy_total, r.parcours_frag.parcours.promotion.moy_accept, r.parcours_frag.parcours.user.lastName,r.parcours_frag.parcours.user.firstName, r.code_student,r.parcours_frag.parcours.id_student,r.parcours_frag.parcours.actived  ")
	 List<MoyDto> getEtudiantsToMG(@Param("id") Long id );
	 
	 // ------------------------------ REPRISE---------------------------------------------//
	 
	 @Query("SELECT new com.hist.BysApp.model.MoyDto(SUM(r.coef*r.note),SUM(r.coef*r.note_total),r.parcours_frag.parcours.user.lastName,r.parcours_frag.parcours.user.firstName,r.code_student,r.parcours_frag.parcours.id_student,r.parcours_frag.parcours.actived,r.parcours_frag.parcours.id, r.parcours_frag.parcours.promotion.moy_total, r.parcours_frag.parcours.promotion.moy_accept,r.parcours_frag.parcours.user.lover,r.parcours_frag.parcours.promotion.moy_reprise) FROM Results r WHERE  r.parcours_frag.promofrag.actived=true AND r.parcours_frag.promofrag.base=true AND  r.parcours_frag.promofrag.reprise=false AND  r.parcours_frag.parcours.promotion.id=:id GROUP BY r.parcours_frag.parcours.promotion.moy_reprise, r.parcours_frag.parcours.id, r.parcours_frag.parcours.user.lover, r.parcours_frag.parcours.promotion.moy_total, r.parcours_frag.parcours.promotion.moy_accept, r.parcours_frag.parcours.user.lastName,r.parcours_frag.parcours.user.firstName, r.code_student,r.parcours_frag.parcours.id_student,r.parcours_frag.parcours.actived   HAVING ((SUM(r.coef*r.note)/SUM(r.coef*r.note_total))*r.parcours_frag.parcours.promotion.moy_total) < r.parcours_frag.parcours.promotion.moy_accept    ORDER BY r.parcours_frag.parcours.user.lastName, r.parcours_frag.parcours.user.firstName ")
	 List<MoyDto> getEtudiantsToFR(@Param("id") Long id );
	 
	 @Query("SELECT new com.hist.BysApp.model.MoyDto(SUM(r.coef*r.note),SUM(r.coef*r.note_total),r.parcours_frag.parcours.user.lastName,r.parcours_frag.parcours.user.firstName,r.code_student,r.parcours_frag.parcours.id_student,r.parcours_frag.parcours.actived,r.parcours_frag.parcours.id, r.parcours_frag.parcours.promotion.moy_total, r.parcours_frag.parcours.promotion.moy_accept,r.parcours_frag.parcours.user.lover,r.parcours_frag.parcours.promotion.moy_reprise) FROM Results r WHERE r.parcours_frag.parcours.id=:idp AND r.parcours_frag.promofrag.actived=true  AND r.parcours_frag.promofrag.reprise=true AND  r.parcours_frag.parcours.promotion.id=:id   GROUP BY r.parcours_frag.parcours.promotion.moy_reprise, r.parcours_frag.parcours.id, r.parcours_frag.parcours.user.lover, r.parcours_frag.parcours.promotion.moy_total, r.parcours_frag.parcours.promotion.moy_accept, r.parcours_frag.parcours.user.lastName,r.parcours_frag.parcours.user.firstName, r.code_student,r.parcours_frag.parcours.id_student,r.parcours_frag.parcours.actived ")
